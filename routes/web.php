...
Route::get('/sk_tidak_mampu', [SKTidakMampuController::class, 'index'])->name('sktm.index');
...
Route::get('/sk_usaha', [SKUsahaController::class, 'index'])->name('sku.index');
...
Route::get('/sk_perkawinan', [SKPerkawinanController::class, 'index'])->name('skp.index');
